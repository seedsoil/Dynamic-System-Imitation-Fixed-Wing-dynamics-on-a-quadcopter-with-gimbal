...
seqList = {
    ...
    [4 +5; 4 +1; 2 +3; 4 -4; 3 -1; 2 +5; 2 +3; 3 +5; 4 +2; 4 -5; 2 +4; 4 +5; 4 +5; 4 +1; 2 +3; 4 -4; 3 -1; 2 +5; 2 +3; 3 +5; 4 +2; 4 -5; 2 +4; 4 +5; 4 +5; 4 +1; 2 +3; 4 -4; 3 -1; 2 +5; 2 +3; 3 +5; 4 +2; 4 -5; 2 +4; 4 +5]    % seq_4p5_4p1_2p3_4n4_3n1_2p5_2p3_3p5_4p2_4n5_2p4_4p5
    %[4 +15; 4 -5; 2 +12; 4 -8; 3 -10; 2 +9; 2 +7; 3 +12; 4 +5; 4 -11; 2 +12; 4 +9]
    [ ...  % a hand-crafted “balanced” sequence (mild + staggered)
      4  +2; 3  +1; 2  +2; 4  -2; 3  +1; 2  +2; 4  +1; 2  +1; ...
      3  +2; 4  -1; 2  +2; 3  -1; 4  +2; 2  +2; 3  +1; 4  +1; ...
      3  -2; 2  +2; 4  -1; 2  +1; 3  +2; 4  +1; 2  +2; 3  +1 ]
};
