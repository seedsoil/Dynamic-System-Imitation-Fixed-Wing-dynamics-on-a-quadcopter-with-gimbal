...
seqList = {
    ...
    % [4 -7; 4 +3; 3 -3; 4 +15; 3 -4; 2 -15; 4 +5; 4 +7]
    % [2 -7; 2 +6; 4 +3; 4 -6; 3 -4; 4 +7; 3 -1; 2 +2]
    % [3 +1; 4 +2; 3 +7; 3 +2; 2 +6; 2 -7; 3 -11; 2 +13]
    % [2 -15; 2 -1; 4 +14; 3 +10; 2 +15; 4 -10; 4 +0; 4 +9]
    % [3 +7; 2 -2; 4 +14; 4 +0; 2 -1; 2 -8; 4 -7; 4 -3]
    % [2 -9; 2 -12; 3 -12; 3 +15; 2 -7; 3 +1; 4 +11; 3 -15]
    % [2 -14; 2 +12; 4 -3; 3 +10; 2 +6; 3 -14; 3 +0; 3 -9]
    % [2 +22; 3 -11; 4 +18; 3 -13; 4 +22; 3 +11; 4 -10; 3 -14]
    % [4 -8; 4 +19; 4 -20; 2 +26; 2 +18; 4 -18; 2 +12; 4 +14]
    % [3 +15; 2 -15; 2 -16; 2 +31; 4 +13; 2 -28; 4 +29; 4 -26]
    % [4 -26; 4 +17; 3 -33; 4 +28; 2 +32; 2 -26; 3 -38; 2 -22]
    % [3 +24; 4 -31; 2 -34; 2 -35; 2 +25; 3 +38; 2 -39; 3 +33]
    %  [3 +25; 2 -25; 2 +25; 3 -25; 3 +25; 2 -25; 2 +25; 3 -25]
 ...
 % 2 +2;   % hold lift
 % 3 -10;  % toward ~40° bank
 % 4 -4;   % keep coordinated
 % 3 -10;  % finish roll-in
 % 2 +3;   % maintain energy in turn
 % 3 -4;   % small trim left
 % 4 -3;   % small yaw trim
 % 3 -3;   % hold bank
 % 2 +4;   % slight extra lift in turn
 % 3 +6;   % start roll-out (right aileron)
 % 4 +2;   % yaw unwind to coordinated
 % 3 +4;   % finish roll-out
 % 2 +5;   % small climb
 % 2 +4]   % continue small climb
